...
def input_image_size(interpreter):
    """
    Return input image size as (width, height, channels) tuple.
    """
...
def input_tensor(interpreter):
    """
    Return input tensor view as numpy array of shape (height, width, 3).
    """
...
def output_tensor(interpreter, i):
    """
    Return dequantized output tensor if quantized before.
    """

...
"""
  avoid_ultrasonic.py
  Press the K2 to start the car.
  The ultrasonic obstacle avoidance function is started.
...
try:
    ...
    while True:
        ...
        if distance > 50:
            run(50, 50)  # Move forward
        elif 30 <= distance <= 50:
            run(35, 35)  # Move forward
        elif distance < 30:
            spin_right(55, 55)
            ...
            if distance >= 30:
                ...
                if distance >= 30:
                    ...
                    spin_left(55, 55)  # Turn left in place
                    time.sleep(0.3)
                    brake()
                    time.sleep(0.001)
